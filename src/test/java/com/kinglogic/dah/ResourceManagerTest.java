...
//        String actual = null;
//        try{
//            actual = ResourceManager.getInstance().saveImage(0, 0, GameManager.MAX_LOBBIES, stream);
//            
//        }catch(Exception e){/*meant to fail*/}
//        assertEquals(expected, actual);
//    }
...
//        String actual = null;
//        try{
//            actual = ResourceManager.getInstance().saveImage(0, GameManager.MAX_LOBBIES, 0, stream);
//        }catch(Exception e){/*meant to fail*/}
//        assertEquals(expected, actual);
//    }
//    @Test
...
//        String actual = null;
//        try{
//            actual = ResourceManager.getInstance().saveImage(GameManager.MAX_LOBBIES,0, 0, stream);
//        }catch(Exception e){/*meant to fail*/}
//        assertEquals(expected, actual);
//    }
//    @Test
...
//        byte[] actual = ResourceManager.getInstance()
//                .getImage(0, 0, GameManager.MAX_LOBBIES);
//        assertEquals(null, actual);
//    }
//    @Test
...
//        byte[] actual = ResourceManager.getInstance()
//                .getImage(0, GameManager.MAX_LOBBIES, 0);
//        assertEquals(null, actual);
//    }
//    @Test
